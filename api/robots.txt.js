...
// This ensures robots.txt is always accessible and bypasses SPA routing issues
...
export default function handler(req, res) {
  ...
  res.status(200).send(`# LocalPDF Robots.txt - Optimized for PDF Tools Search Engine Visibility
