...
const alignment_2 = require("../text/alignment");
 ...
 */
class PDFTextField extends PDFField_1.default {
    constructor(acroText, ref, doc) {
        super(acroText, ref, doc);
        (0, utils_1.assertIs)(acroText, 'acroText', [[core_1.PDFAcroText, 'PDFAcroText']]);
    ...
    setAlignment(alignment) {
        (0, utils_1.assertIsOneOf)(alignment, 'alignment', alignment_2.TextAlignment);
        this.markAsDirty();
    ...
    setMaxLength(maxLength) {
        (0, utils_1.assertRangeOrUndefined)(maxLength, 'maxLength', 0, Number.MAX_SAFE_INTEGER);
        this.markAsDirty();
    ...
    setImage(image) {
        ...
        // prettier-ignore
        const alignment = fieldAlignment === alignment_2.TextAlignment.Center ? alignment_1.ImageAlignment.Center
    ...
    addToPage(page, options) {
        ...
        const widget = this.createWidget({
            ...
            rotate: (_f = options.rotate) !== null && _f !== void 0 ? _f : (0, rotations_1.degrees)(0),
    ...
    needsAppearancesUpdate() {
        ...
        for (let idx = 0, len = widgets.length; idx < len; idx++) {
            const widget = widgets[idx];
            const hasAppearances = ((_a = widget.getAppearances()) === null || _a === void 0 ? void 0 : _a.normal) instanceof core_1.PDFStream;
            if (!hasAppearances)
                return true;
        }
        return false;
    ...
    updateWidgetAppearance(widget, font, provider) {
        const apProvider = provider !== null && provider !== void 0 ? provider : appearances_1.defaultTextFieldAppearanceProvider;
