...
const PDFField_1 = tslib_1.__importStar(require("./PDFField"));
 ...
 */
class PDFRadioGroup extends PDFField_1.default {
    constructor(acroRadioButton, ref, doc) {
        super(acroRadioButton, ref, doc);
        (0, utils_1.assertIs)(acroRadioButton, 'acroRadioButton', [
     ...
     */
    select(option) {
        (0, utils_1.assertIs)(option, 'option', ['string']);
        const validOptions = this.getOptions();
        (0, utils_1.assertIsOneOf)(option, 'option', validOptions);
        this.markAsDirty();
        const onValues = this.acroField.getOnValues();
        const exportValues = this.acroField.getExportValues();
        if (exportValues) {
    ...
    addOptionToPage(option, page, options) {
        ...
        const widget = this.createWidget({
            ...
            textColor: (_e = options === null || options === void 0 ? void 0 : options.textColor) !== null && _e !== void 0 ? _e : (0, colors_1.rgb)(0, 0, 0),
            backgroundColor: (_f = options === null || options === void 0 ? void 0 : options.backgroundColor) !== null && _f !== void 0 ? _f : (0, colors_1.rgb)(1, 1, 1),
            borderColor: (_g = options === null || options === void 0 ? void 0 : options.borderColor) !== null && _g !== void 0 ? _g : (0, colors_1.rgb)(0, 0, 0),
            borderWidth: (_h = options === null || options === void 0 ? void 0 : options.borderWidth) !== null && _h !== void 0 ? _h : 1,
            rotate: (_j = options === null || options === void 0 ? void 0 : options.rotate) !== null && _j !== void 0 ? _j : (0, rotations_1.degrees)(0),
            hidden: options === null || options === void 0 ? void 0 : options.hidden,
        });
        const widgetRef = this.doc.context.register(widget.dict);
        // Add widget to this field
        const apStateValue = this.acroField.addWidgetWithOpt(widgetRef, core_1.PDFHexString.fromText(option), !this.isMutuallyExclusive());
    ...
    updateWidgetAppearance(widget, onValue, provider) {
        const apProvider = provider !== null && provider !== void 0 ? provider : appearances_1.defaultRadioGroupAppearanceProvider;
