 ...
 */
class PDFOptionList extends PDFField_1.default {
    constructor(acroListBox, ref, doc) {
        super(acroListBox, ref, doc);
        (0, utils_1.assertIs)(acroListBox, 'acroListBox', [[core_1.PDFAcroListBox, 'PDFAcroListBox']]);
     ...
     */
    setOptions(options) {
        (0, utils_1.assertIs)(options, 'options', [Array]);
        this.markAsDirty();
     ...
     */
    addOptions(options) {
        (0, utils_1.assertIs)(options, 'options', ['string', Array]);
        this.markAsDirty();
    ...
    select(options, merge = false) {
        (0, utils_1.assertIs)(options, 'options', ['string', Array]);
        (0, utils_1.assertIs)(merge, 'merge', ['boolean']);
        const optionsArr = Array.isArray(options) ? options : [options];
        const validOptions = this.getOptions();
        (0, utils_1.assertIsSubset)(optionsArr, 'option', validOptions);
        this.markAsDirty();
    ...
    updateWidgetAppearance(widget, font, provider) {
        const apProvider = provider !== null && provider !== void 0 ? provider : appearances_1.defaultOptionListAppearanceProvider;
