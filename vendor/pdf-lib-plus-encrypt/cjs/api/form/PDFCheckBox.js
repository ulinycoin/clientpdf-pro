...
class PDFCheckBox extends PDFField_1.default {
    constructor(acroCheckBox, ref, doc) {
        ...
        (0, utils_1.assertIs)(acroCheckBox, 'acroCheckBox', [
    ...
    check() {
        var _a;
        const onValue = (_a = this.acroField.getOnValue()) !== null && _a !== void 0 ? _a : core_1.PDFName.of('Yes');
        this.markAsDirty();
    ...
    updateAppearances(provider) {
        ...
        for (let idx = 0, len = widgets.length; idx < len; idx++) {
            const widget = widgets[idx];
            const onValue = (_a = widget.getOnValue()) !== null && _a !== void 0 ? _a : core_1.PDFName.of('Yes');
            if (!onValue)
                continue;
    ...
    updateWidgetAppearance(widget, onValue, provider) {
        const apProvider = provider !== null && provider !== void 0 ? provider : appearances_1.defaultCheckBoxAppearanceProvider;
