 ...
 */
class PDFDropdown extends PDFField_1.default {
    constructor(acroComboBox, ref, doc) {
        super(acroComboBox, ref, doc);
        (0, utils_1.assertIs)(acroComboBox, 'acroComboBox', [
    ...
    updateWidgetAppearance(widget, font, provider) {
        const apProvider = provider !== null && provider !== void 0 ? provider : appearances_1.defaultDropdownAppearanceProvider;
