/**
 * Home page translations for French language
...
export const home = {
  ...
  tools: {
    ...
    whyChoose: {
      ...
      description: 'Outils de traitement PDF professionnels qui fonctionnent directement dans votre navigateur',
      stats: {
        tools: '13',
        toolsDesc: 'Outils professionnels',
        privacy: '100%',
        privacyDesc: 'Confidentialité protégée',
        dataCollection: '0',
        dataCollectionDesc: 'Collecte de données',
        usageLimits: '∞',
        usageLimitsDesc: 'Limites d\'utilisation'
      }
    },
  ...
  privacy: {
    ...
    subtitle: 'Vos fichiers ne quittent jamais votre appareil',
    description: 'Tout le traitement PDF se fait directement dans votre navigateur. Aucun téléchargement, aucun suivi, confidentialité complète.',
    features: [
      {
        title: 'Aucun téléversement de fichiers',
        description: 'Les fichiers sont traités localement dans votre navigateur'
      },
      {
        title: 'Confidentialité complète',
        description: 'Aucune collecte de données ou suivi'
      },
      {
        title: 'Traitement sécurisé',
        description: 'Toutes les opérations se font sur votre appareil'
      }
    ]
  },
