/**
 * Home page translations for DE language
...
export const home = {
  ...
  tools: {
    ...
    categories: {
      core: {
        title: 'Kern-Tools',
        description: 'Essenzielle PDF-Tools für den täglichen Gebrauch'
      },
      enhancement: {
        title: 'Verbesserungs-Tools',
        description: 'Erweiterte PDF-Verbesserung und -Modifikation'
      },
      advanced: {
        title: 'Erweiterte Tools',
        description: 'Professionelle PDF-Verarbeitung und -Konvertierung'
      },
      conversion: {
    ...
    whyChoose: {
      ...
      description: 'Professionelle PDF-Verarbeitungstools, die direkt in Ihrem Browser funktionieren',
      stats: {
        tools: '13',
        toolsDesc: 'Professionelle Tools',
        privacy: '100%',
        privacyDesc: 'Datenschutz geschützt',
        dataCollection: '0',
        dataCollectionDesc: 'Datensammlung',
        usageLimits: '',
        usageLimitsDesc: 'Nutzungslimits'
      }
    },
    trustMessage: 'Weltweit vertraut für sichere PDF-Verarbeitung'
  },
  privacy: {
    title: 'Datenschutz zuerst',
    subtitle: 'Ihre Dateien verlassen niemals Ihr Gerät',
    description: 'Die gesamte PDF-Verarbeitung erfolgt direkt in Ihrem Browser. Keine Uploads, kein Tracking, vollständiger Datenschutz.',
    features: [
      {
        title: 'Keine Datei-Uploads',
        description: 'Dateien werden lokal in Ihrem Browser verarbeitet'
      },
      {
        title: 'Vollständiger Datenschutz',
        description: 'Keine Datensammlung oder Tracking'
      },
      {
        title: 'Sichere Verarbeitung',
        description: 'Alle Operationen passieren auf Ihrem Gerät'
      }
    ]
  },
  quickStart: {
