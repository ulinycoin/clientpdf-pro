...
import { useSimpleBlogCategory, usePaginatedSimpleBlogPosts } from '../hooks/useSimpleBlog';
...
export const BlogCategoryPage: React.FC = () => {
  ...
  const { category, posts: categoryPosts, loading: categoryLoading, notFound } = useSimpleBlogCategory(categorySlug!, currentLanguage);
  ...
  } = usePaginatedSimpleBlogPosts(currentPage, 12, categorySlug, undefined, currentLanguage);
