...
const ToolCard: React.FC<ToolCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50/50 to-blue-50/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl" />
      ...
      <div className="relative z-10">
        ...
        <div className="text-center space-y-3">
          <h3 className={`
            ...
            ${disabled ? 'text-gray-400' : 'text-gray-900 group-hover:text-blue-900'}
            transition-colors duration-200
          `}>
            {title}
          </h3>
