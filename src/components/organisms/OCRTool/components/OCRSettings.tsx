          ...
          <div className="space-y-2">
            <label className="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
              ...
              <div>
                ...
                <div className="text-xs text-gray-500">Extract text only</div>
              </div>
            </label>
            ...
            <label className="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
              ...
              <div>
                ...
                <div className="text-xs text-gray-500">PDF with searchable text layer</div>
              </div>
            </label>
          </div>
        </div>
          ...
          <div className="space-y-2">
            <label className="flex items-center">
              ...
              <div>
                ...
                <div className="text-xs text-gray-500">Maintain document structure</div>
              </div>
            </label>
            ...
            <label className="flex items-center">
              ...
              <div>
                ...
                <div className="text-xs text-gray-500">Enhance image quality</div>
              </div>
            </label>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-green-50 rounded-lg p-3 space-y-2">
              ...
              <div className="text-sm">
                <div className="font-medium text-green-800">Words Found</div>
